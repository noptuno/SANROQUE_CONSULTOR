...
public class ConnectionSettingsActivityDispensador extends AppCompatActivity {
		...
		SavetButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				//=====Error handling============//
					...
					nfe.printStackTrace();
					AlertDialog.Builder builder = new AlertDialog.Builder(ConnectionSettingsActivityDispensador.this);
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mDevice != null) {
					...
					if (mUsbManager.hasPermission(mDevice)) {
						...
						mPermissionIntent = PendingIntent.getBroadcast(ConnectionSettingsActivityDispensador.this, 0, new Intent(ACTION_USB_PERMISSION), 0);
